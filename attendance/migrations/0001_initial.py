# Generated by Django 3.1.2 on 2021-07-20 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_leave', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='attendance.total_leave')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('病假', '病假'), ('生理假', '生理假'), ('事假', '事假'), ('家庭照顧假', '家庭照顧假'), ('育嬰假', '育嬰假'), ('無薪假', '無薪假'), ('防疫隔離假', '防疫隔離假'), ('防疫照顧假', '防疫照顧假'), ('疫苗接種假', '疫苗接種假'), ('因公隔離', '因公隔離'), ('出差', '出差'), ('公假', '公假'), ('工傷假', '工傷假'), ('喪假', '喪假'), ('婚假', '婚假'), ('產假', '產假'), ('陪產假', '陪產假'), ('產前假', '產前假'), ('特休', '特休'), ('補休', '補休')], default='特休', max_length=64)),
